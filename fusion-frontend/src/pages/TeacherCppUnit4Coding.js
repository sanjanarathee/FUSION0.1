...
export default function TeacherCppUnit4Coding() {
  ...
  // ============================
  // 🔥 FETCH ALL CPP UNIT 4 QUESTIONS
  // ============================
  const fetchQuestions = async () => {
    try {
      const res = await axios.get(
        "https://fusion0-1.onrender.com/api/coding/get?unit=CPP Unit 4"
      );
  ...
  return (
    <div className="learn-container">
      <h1 className="learn-title">
        💻 Add Coding Practice Question (C++ Unit 4)
      </h1>
